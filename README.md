# You Can Clone SpeedoNews App On GitHub

You can clone the SpeedoNews app on GitHub by following these steps:
1.  Go to the GitHub website and search for the SpeedoNews app.
